class MQ2(BaseMQ):
	...
	def _init_(self, pinData, pinHeater=-1, boardResistance = 10, baseVoltage = 3.3, measuringStrategy = BaseMQ.STRATEGY_ACCURATE):
		# Call superclass to fill attributes
		super()._init_(pinData, pinHeater, boardResistance, baseVoltage, measuringStrategy)
		pass
